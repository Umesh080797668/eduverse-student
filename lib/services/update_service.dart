...
class UpdateService {
  // Use raw.githubusercontent.com for update check
  static String get _updateCheckUrl =>
      dotenv.env['UPDATE_CHECK_URL'] ??
      'https://raw.githubusercontent.com/Umesh080797668/eduverse-student/main/update.json';
  ...
  Future<bool> downloadAndInstallUpdate(
    ...
    try {
      ...
      final savePath = '${dir.path}/student_app_update.apk';
  ...
  /// Check if enough time has passed since last background check
