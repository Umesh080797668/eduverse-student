        ...
        return Column(
          ...
          children: [
            ...
            ...sortedMonths.map((month) {
              ...
              final excused = monthAttendance.where((a) => a.status.toLowerCase() == 'excused').length;
              final total = monthAttendance.length;
              final percentage = total > 0 ? ((present + late + excused) / total * 100).toStringAsFixed(1) : '0.0';
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            _buildSummaryBadge('Excused', excused, Colors.blue),
                          ],
                        ),
                      ],
                    ),
            ...
            ...sortedMonths.map((month) {
              ...
              return Column(
                ...
                children: [
                  ...
                  ...monthPayments.map((payment) => Card(
                    margin: const EdgeInsets.only(bottom: 8),
                    elevation: 1,
                    child: Padding(
                      padding: const EdgeInsets.all(12.0),
